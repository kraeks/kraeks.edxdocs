...
set BUILDDIR=/var/www/sphinx/docs
set ALLSPHINXOPTS=-d %BUILDDIR%/doctrees %SPHINXOPTS% /var/www/sphinx/docs-source
set I18NSPHINXOPTS=%SPHINXOPTS% /var/www/sphinx/docs-source
if NOT "%PAPER%" == "" (
